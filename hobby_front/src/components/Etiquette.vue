<template>
  <v-carousel id="etiquetteCaro" hide-delimiters> 
    <v-carousel-item v-for="(slide, i) in slides" :key="i" style="height:100%">
        ...
        <v-parallax  v-else-if="slide==2" src="https://www.colorbook.io/imagecreator.php?hex=f1bbba&width=1920&height=1080&text=%201920x1080"  class="pa-10">
            <h1 class="gamjaFont" id="subTitle">지켜주세요</h1>
