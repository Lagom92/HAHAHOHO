<template>
    <v-carousel id="introCaro" hide-delimiters>
        <v-carousel-item v-for="(slide, i) in slides" :key="i">
            <v-row justify="center" align="center" id="introSlide1" v-if="slide==1">
            ...
            <v-row justify="center" align="center" id="introSlide2" v-else-if="slide==2">
                <div>
                    <h1 class="gamjaFont mb-10 text-center" id="subTitle">우리 사이트는요</h1>
                    <v-row>
